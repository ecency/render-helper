...
function markdown2Html(obj, forApp, webp, amp, ampCallback) {
    ...
    if (typeof obj === "string") {
        ...
        var html_1 = methods_1.markdownToHTML(obj, forApp, webp);
        if (amp && ampCallback) {
            var ampOptimizer = AmpOptimizer.create({
                markdown: true,
            });
            ampOptimizer
                .transformHtml(html_1)
                .then(function (res) { return ampCallback(res, html_1); });
        }
        return html_1;
    }
    ...
    if (amp && ampCallback) {
        ...
        ampOptimizer.transformHtml(res).then(function (r) { return ampCallback(r, res); });
    }
