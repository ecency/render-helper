...
describe('catchPostImage', () => {
  it('1- Should extract entry image from json_metadata', () => {
    ...
    const expected = 'https://steemitimages.com/0x0/http://www.autonews.com/apps/pbcsi.dll/storyimage/CA/20180205/MOBILITY/180209919/AR/0/AR-180209919.jpg';
  ...
  it('2- Should extract entry image from json_metadata', () => {
    ...
    const expected = 'https://steemitimages.com/0x0/https://i.imgur.com/NUt92kg.jpg';
  ...
  it('4- Should extract entry image from image link', () => {
    ...
    const expected = 'https://steemitimages.com/0x0/https://ipfs.io/ipfs/aa.png';
  ...
  it('5- Should extract entry image from img tag', () => {
    ...
    const expected = 'https://steemitimages.com/0x0/https://ipfs.io/ipfs/QmaG5Dpg1XGiY7EyeMCwT8Dqw4GfiAaehq3hZadongniQc';
