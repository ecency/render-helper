...
describe('catchPostImage', () => {
  ...
  it('2- Should extract entry image from json_metadata', () => {
    const input = {
      ...
      permlink: 'bar2',
      json_metadata:
        '{"community":"busy","app":"busy/2.3.0","format":"markdown","users":["gavvet","kingscrown","vcelier","ezzy","meesterboom","thecryptodrive","reggaemuffin","adsactly","adsactly-witness","buildteam","minnowbooster","steemvoter","steemsports"],"links":["https://imgur.com/NUt92kg","/@gavvet","/@kingscrown","/@vcelier","/@ezzy","/@meesterboom","/@thecryptodrive","/@reggaemuffin","/@adsactly","/@adsactly-witness"],"image":["https://images.hive.blog/0x0/https://i.imgur.com/NUt92kg.jpg","https://images.hive.blog/0x0/https://images.hive.blog/DQmXndfFUQmmtMk5Dd6u1nRNmNqr2mdkEGDVkT9SNyCxEeP/bt%20logo.png","https://images.hive.blog/0x0/https://images.hive.blog/DQmd5CQG5zLjjm2z8289qcLU6eBHJpC5FmgtR3aC1eXnhsi/Adsactly-Logo-200px.png"],"tags":["art","photography","adsactly","thoughts","busy"]}',
      body: '',
      last_update: '2019-05-10T09:15:21'
    };

    const expected = 'https://images.hive.blog/0x0/https://i.imgur.com/NUt92kg.jpg';
  ...
  it('4- Should extract entry image from image link', () => {
    ...
    const expected = 'https://images.hive.blog/0x0/https://ipfs.io/ipfs/aa.png';
  ...
  it('5- Should extract entry image from img tag', () => {
    ...
    const expected = 'https://images.hive.blog/0x0/https://ipfs.io/ipfs/QmaG5Dpg1XGiY7EyeMCwT8Dqw4GfiAaehq3hZadongniQc';
  ...
  it('6- Should extract entry image from markdown img tag', () => {
    ...
    const expected = 'https://images.hive.blog/0x0/https://img.esteem.ws/ezrni9y9pw.jpg';
