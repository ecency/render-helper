...
describe('Proxify image src', () => {
  ...
  it('1- should proxify image src', () => {
    ...
    const expected = 'https://images.ecency.com/0x0/https://i.imgur.com/muESb0B.png';
  ...
  it('2- should not proxify if already proxified', () => {
    ...
    const expected = 'https://images.ecency.com/0x0/https://images.ecency.com/DQmWK9ACVoywHPBJQdoTuJpoTSoaubBSKSAdZaJtw1cfLb9/adsactlywitness.gif';
