...
const SNAPSHOT_JSON = {
  ...
  "markdown_2_amp_html_mix": "<div class=\"text-justify\"> <center>![IMG_20210511_181315.jpg](https://img.travelfeed.io/bengy%2F2021-06-15-08-06-200-img_20210511_181315-jpg)</center> First up, my most sincere apologies to the Czech readers for the loss of all the inflections in the name Obecni dum (Municipal House). I'm just a sad English language native, and it have nightmares trying to write out all those little things on an English keyboard! Probably, I should try to find an internet version of it and just cut and paste the name, that would be easier! Obecní dům, there you go! </div> <hr /><center><em>View this post <a href=\"https://travelfeed.io/@bengy/obecni-dum-smetana-hall-prague-czech-republic\">on TravelFeed</a> for the best experience.</em></center> [//]:# (!pinmapple 50.783106 lat 14.361808 long d3scr)"
}
...
describe('Markdown2Html', () => {
  ...
  describe('AMP files', () => {
    it('1- Should handle links AMP', () => {
      const data = getTestData(
        'bengy',
        'obecni-dum-smetana-hall-prague-czech-republic'
      )

      data['author'] = 'bengy'
      data['permlink'] = 'obecni-dum-smetana-hall-prague-czech-republic'
      data['last_update'] = '2019-05-10T09:15:21'
      expect(markdown2Html(data, false, false, true)).toBe(SNAPSHOT_JSON.markdown_2_amp_html_mix)
    })
